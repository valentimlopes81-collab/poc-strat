...
| L7 | 18/09 | (1 MNQ) | **Trade puramente administrativa** — só p/ não cair na inatividade | — | ❌ Loss | −1R | **−$125** | Trade só de manutenção de conta (não foi um setup). ⚠️ Pagou risco de trade normal ($125) por algo que devia custar quase $0 (entrar e sair no ato = ping-trade, só comissão/spread). Nota a levar: reservar as trades reais para setups A e usar um **ping-trade mínimo** quando o motivo é só o contador |
